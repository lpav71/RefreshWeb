<template>
    <div class="main">
        <div class="top">
            ...
            <button class="btn bt" style="margin-left: 10px;">Портал статистики</button>
        </div>
        <div class="bottom">
            <div class="left_part">
                <div class="left_top">
