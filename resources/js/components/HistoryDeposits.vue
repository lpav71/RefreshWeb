    ...
    <div class="home">
        ...
        <table class="table table-borderless t1" style="margin-top: 20px;">
            ...
            <tr>
                ...
                <th style="width: 14.3%">Детали операции</th>
                <th style="width: 14.3%">Сумма</th>
                <th style="width: 14.3%">Способ оплаты</th>
                <th style="width: 14.3%">Источник</th>
            </tr>
            </thead>
        </table>
        <div class="fon">
            <table class="table table-borderless t2">
                <tbody>
                <tr v-for="(d, index) in deposits">
                    <td style="width: 14.3%">{{ d.dt_operation }}</td>
                    <td style="width: 14.3%">{{ d.login }}</td>
                    <td style="width: 14.3%">{{ d.name }}</td>
                    <td style="width: 14.3%">Стандарт 3 часа</td>
                    <td style="width: 14.3%">{{ d.amount }}</td>
                    <td style="width: 14.3%">{{ d.type }}</td>
                    <td style="width: 14.3%">CRM</td>
                </tr>
                </tbody>
            </table>
        </div>
    ...
    methods: {
        async generateReport() {
            ...
            var raw = JSON.stringify({
                ...
                "header"    : "Дата/время, Пользователь, Администратор, Сумма, Способ оплаты"
            });
        ...
        async getDeposits() {
            ...
            var response = await fetch("api/deposit", requestOptions);
            if (response.ok) {
