<template>
    <div class="home">
        ...
        <div class="header_bottom">
            <div class="header_bottom_left">
                ...
                <input v-model="searchUser" class="search-user" placeholder="Поиск" type="text" @keydown="enter"/>
                <div class="btn-group btn_select_wrapper">
                    <button aria-expanded="false" class="btn btn-success dropdown-toggle" data-bs-toggle="dropdown" type="button">
                        Возраст
                    </button>
                ...
                <button class="btn btn-success">
                    <img alt="" src="/images/head_bottom/setting.svg"/>
                </button>
            </div>
            <div class="header_bottom_right">
                <div class="rw">
                    <label class="btn btn-success" for="import">Импорт</label>
                    <input id="import" ref="import" style="display: none" type="file" @change="importClients">
                </div>
                ...
                <button class="btn btn-success"><img alt="" src="/images/head_bottom/arrov.svg"/></button>
                <button class="btn btn-success"><img alt="" src="/images/head_bottom/arrov_top.svg"/></button>
            </div>
        </div>
        ...
        <div class="fon">
            <table class="table table-borderless t2">
                <tbody>
                <tr v-for="(user, index) in findUsers" style="cursor: pointer" @contextmenu.prevent="contextMenuShow($event, index)">
                    ...
                    <td style="width: 411px">
                        ...
                        <button class="btn btn-success me-2" @click="calendarButton(index)"><img alt="" src="img/calendar.svg"></button>
                        <button class="btn btn-success me-2" @click="cashButton(index)"><img alt="" src="img/cash.svg"></button>
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="main">
                        <div class="div_1">
                            <span style="margin-left: 10px">Сумма</span><input id="sum" v-model.number="summa" class="input_1" maxlength="10" type="text" @input="numVerify"/>
                        </div>
                        <div class="div_2">
                        ...
                        <div class="div_1">
                            <div class="div_1" style="height: 125px">
                                <span style="margin-left: 10px">Комментарий к платежу</span><textarea v-model="comment" class="input_1" style="height: 100px" type="text"></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button :disabled="payTextDisabled" class="btn btn-success" type="button" @click="payment">{{ payText }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="reservationModal" aria-hidden="true" aria-labelledby="reservationModalLabel" class="modal fade" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="reservationModalLabel" class="modal-title">Резервации</h5>
                    <button aria-label="Закрыть" class="btn-close" data-bs-dismiss="modal" type="button"></button>
                </div>
                <div class="modal-body">
    ...
    <div id="cashModal" aria-hidden="true" aria-labelledby="cashModalLabel" class="modal fade" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="cashModalLabel" class="modal-title">Движение средств</h5>
                    <button aria-label="Закрыть" class="btn-close" data-bs-dismiss="modal" type="button"></button>
                </div>
                <div class="modal-body">
    ...
    <div id="userCardModal" aria-hidden="true" aria-labelledby="userCardModalLabel" class="modal fade" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="userCardModalLabel">Карта пользователя</h5><h5 v-if="!verifyM" style="margin-left: 20px">Требует верификации</h5>
                    <button aria-label="Закрыть" class="btn btn-close" data-bs-dismiss="modal" type="button"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-4">
                            <div class="div_1"><span>Никнейм</span><input v-model="loginM" class="input_1 rounded" type="text"></div>
                            <div class="div_1"><span>Фамилия</span><input v-model="surnameM" class="input_1 rounded" type="text"></div>
                            <div class="div_1"><span>Имя</span><input v-model="nameM" class="input_1 rounded" type="text"></div>
                            <div class="div_1"><span>Отчество</span><input v-model="middleNameM" class="input_1 rounded" type="text"></div>
                            <div class="div_1"><span>Откуда узнали о клубе</span><input class="input_1 rounded" type="text"></div>
                            <button class="btn btn-success" type="button">Расширенная регистрация</button>
                        </div>
                        <div class="col-4">
                            <div class="div_1"><span>Дата рождения</span><input v-model="bdayM" class="input_1 rounded" type="text"></div>
                            <div class="div_1"><span>Номер телефона</span><input v-model="phoneM" class="input_1 rounded" type="text"></div>
                            <div class="div_1"><span>Местоположение</span><input class="input_1 rounded" type="text"></div>
                            <div class="div_1"><span>Почта</span><input v-model="emailM" class="input_1 rounded" type="text"></div>
                        </div>
                        <div class="col-4">
                            <div class="text-block"><span>Описание</span>
                                <div class="input_1 rounded" style="height: 380px;padding: 5px">
                                    ...
                                    <div class="note_main">
                                        <div v-for="(s, i) in notes" class="note">
                                            <div style="color: #61babe">Запись #{{ i+1 }}</div>
                                            <div style="margin-top: 10px;font-size: 11px">{{ s.note }}</div>
                                        </div>
                                    </div>
                                    <div class="new-rec">
                                        <input v-model="newMind" class="input_1" placeholder="Запиши мысль, чтобы не забыть..." style="margin-left: -20px; width: 208px; font-size: 8px">
                ...
                <div class="modal-footer">
                    <button class="btn btn-success" type="button">Сброс пароля</button>
                    <button class="btn btn-success" type="button">Редактировать</button>
                    <button class="btn btn-success" type="button">Сохранить изменения</button>
                </div>
            </div>
        </div>
    </div>
